...
class AdminController extends Controller
{
    ...
    /**
     * @Route("/omdb/import/{id}", name="admin_omdb_import")
     */
    public function omdbAdd($id)
    {
        $omdb = new OMDbAPI(null, true);
        $import = $omdb->fetch('i', $id);
        $show = new TVShow;
        $show->setName($import["data"]["Title"]);
        $show->setSynopsis($import["data"]["Plot"]);
        $show->setImage($import["data"]["Poster"]);
    ...
    public function deleteSeasonAction($id)
    {
        ...
        return $this->redirect($this->generateUrl('show', ['id' => $tvShow]));
    }
}
